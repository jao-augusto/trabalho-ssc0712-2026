...
def generate_launch_description():
    ...
    # localizado na pasta `description` do pacote `capote`.
    urdf_path = PathJoinSubstitution([
        FindPackageShare("capote"),         # Diretório do pacote `capote`
    ...
    diff_drive_params = os.path.join(
        FindPackageShare("capote").find("capote"),
        "config",
    ...
    # ------------------------------------------------------
    # Carrega o arquivo de configuração do RViz a partir do pacote `capote`.
    rviz_config_file = PathJoinSubstitution([
        FindPackageShare("capote"),
        "rviz",
        "rviz_config.rviz"
    ])
    ...
    spawn_entity = Node(
        ...
        output="screen",
        arguments=[
            "-name", "capotinho",          # Nome da entidade no simulador
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            "/model/capotinho/pose@geometry_msgs/msg/Pose[gz.msgs.Pose",
        ],
        output="screen",
    )
